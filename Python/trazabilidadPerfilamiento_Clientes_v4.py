...
#3
SERVICIO = 'PERFILAMIENTO_CLIENTES'
while(periodo_hasta >= periodo_desde):
    print("============================================")
    ...
    print "{}. LIMPIARTABLATEMPORAL temp_perfilamiento_trazabilidad_nrt".format(paso)
    ...
    EjecutarPaso("CONSULTAPERFIL_CLOUD.sql")
    EjecutarPaso("ENCUESTA_CLOUD.sql")
    EjecutarPaso("GENERACIONPERFIL_CLOUD.sql")
    EjecutarPaso("TEXTO_RESPUESTA.sql")    
    EjecutarPaso("RESULTADO_PERFILAMIENTO.sql")
    EjecutarPaso("CONSULTA_ENCUESTA.sql")
    ...
    impala_shell_execute(config_log['INVALIDAR_METADATA'].format(bd_final=config_log['bd_final'],TABLA='perfilamiento_trazabilidad_nrt' ))
